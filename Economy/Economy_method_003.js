Economy.prototype.consumer_deposits_currency_in_a_comercial_bank = function(x) {
  
  let transaction_id = '003';
  let desc = 'consumers deposit currency in a commercial bank in exchange for deposits';
